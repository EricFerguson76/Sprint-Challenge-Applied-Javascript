...
The DOM is an object representation of the HTML elements of a website. It allows us to be able to manipulate that page.
...
An event listener is when we can choose specific elements to listen to and fire a callback when that event occurs.
